...
public class RSA {
    ...
    {
        String chars = "`;1234567890QWERTYUIOPASDFGHJKLZXCVBNM a-=qwertyuiop[]asdfghjkl'zxcvbnm,./{}:ąęśćżźńół\"\\_+!@#$%^*()";
    ...
    public String encryptMessageRSA(String message, String public_key1, String public_key2, int keyLongEncrypt ) {
        ...
        for( int i = 0; i < message.length(); i++ )
        {
            ...
            System.out.println("symbol#: " + m_ + "*" + i );
            if( m * 100 + m_ < n )
            {
                m = m * 100 + m_;
            }
    ...
    public String decryptMessageRSA(String message) {
        ...
        for( i = 0; i < msg.length() - 1; i += 2 )
        {
            ...
            System.out.println( Integer.parseInt( msg.substring( i, i + 2 ) ) + "!" + ch );
            msg2 += ch;
        }
        return msg2;
    }
